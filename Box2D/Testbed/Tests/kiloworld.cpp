...
void Kiloworld::parse_worldfile(float xoffset, float yoffset)
{
    ...
    for(int entity=1; entity < wf->GetEntityCount(); entity++)
    {
        ...
        if (entity_parent == 0 && !strcmp(typestr, "position"))
        {
            ...
            if (words[0] == "evokilo6")
                bots.push_back((Kilobot*)(new Evokilo6(mod, settings, words, logfile.c_str())));
            if (words[0] == "evokilo7")
                bots.push_back((Kilobot*)(new Evokilo7(mod, settings, words, logfile.c_str())));
            if (words[0] == "evokilo8")
                bots.push_back((Kilobot*)(new Evokilo8(mod, settings, words, logfile.c_str())));
            if (words[0] == "evokilo9")
                bots.push_back((Kilobot*)(new Evokilo9(mod, settings, words, logfile.c_str())));
            if (words[0] == "evokilo10")
                bots.push_back((Kilobot*)(new Evokilo10(mod, settings, words, logfile.c_str())));
            if (words[0] == "evokilo11")
                bots.push_back((Kilobot*)(new Evokilo11(mod, settings, words, logfile.c_str())));
            if (words[0] == "evokilo12")
                bots.push_back((Kilobot*)(new Evokilo12(mod, settings, words, logfile.c_str())));
            //----------------------------------------------------------------------------------
...
void Circle::render()
{
    ...
    switch(rt)
    {
        case(0): glColor4f(0.0, 1.0, 0.0, 1.0);break;
        case(1): glColor4f(0.9, 0.9, 0.9, 1.0);break;
        case(2): glColor4f(0.7, 0.7, 0.7, 1.0);break;
        case(3): glColor4f(2.0, 1.0, 1.0, 0.8);break;
    }
...
void Rectangle::render()
{
    ...
    switch(rt)
    {
        ...
        case(1): glColor4f(0.9, 0.9, 0.9, 1.0);break;
        case(2): glColor4f(0.7, 0.7, 0.7, 1.0);break;
        case(3): glColor4f(0.3, 0.1, 0.1, 0.8);break;
        case(4): glColor4f(0.9, 0.1, 0.7, 0.2);break;
    }
    glBegin(GL_QUADS);
